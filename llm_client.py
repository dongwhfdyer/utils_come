...
class ModelConfig:
    ...
    def __init__(self, config_dict: Dict[str, Any], model_id: str):
        ...
        self.max_tokens = output_config.get("max_tokens", 4096)
        self.temperature = output_config.get("temperature", 0.7)
        self.top_p = output_config.get("top_p")
        self.top_k = output_config.get("top_k")
        self.repetition_penalty = output_config.get("repetition_penalty")
        self.seed = output_config.get("seed")
        self.extra_body = output_config.get("extra_body")

        # Store full output config for easy access
    ...
    def get_generation_params(
        ...
        **override_kwargs
        ...
        """
        Get generation parameters for this model, with optional overrides
    ...
    def chat_completion(
        ...
        **kwargs
        ...
        Args:
            ...
            **kwargs: Additional parameters to pass to the API (will override config)
        ...
        # Get generation parameters from model config, with overrides
        gen_params = model_config.get_generation_params(
