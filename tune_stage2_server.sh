#!/bin/bash
# Tune Stage 2 parameters on Server (zhixingyun)

set -e

echo "==========================================="
echo "STAGE 2 PARAMETER TUNING - Server"
echo "==========================================="
...
OUTPUT_DIR="outputs/tuning_stage2_server"
...
echo ""
echo "Next: Update run_stage2_captions_server.sh with optimal parameters"
echo ""
